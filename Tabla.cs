...
namespace TablaPeriodica
{
    public partial class TablaPeriodica : Form
    {
        ...
        private void btn_ni_Click(object sender, EventArgs e)
        {
            Form form = new Ni();
            form.ShowDialog();
        }
        ...
        private void btn_te_Click(object sender, EventArgs e)
        {
            Form form = new Te();
            form.ShowDialog();
        }
        ...
        private void btn_he_Click(object sender, EventArgs e)
        {
            Form form = new He();
            form.ShowDialog();
        }
        ...
        private void btn_kr_Click(object sender, EventArgs e)
        {
            Form form = new Kr();
            form.ShowDialog();
        }
        ...
        private void btn_og_Click(object sender, EventArgs e)
        {
            Form form = new Og();
            form.ShowDialog();
        }
